(function (window) {
  ...
  // Uses /api/telemetry proxy to avoid ad blocker detection
  // Proxy forwards to penguin-analytics at http://localhost:3000/events
  window.__env.ANALYTICS_API_URL = '/api/telemetry';
