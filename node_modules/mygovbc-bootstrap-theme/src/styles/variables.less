...
@font-size-h1:            28px;
@font-size-h2:            floor((@font-size-base * 1.5)); // ~21px
@font-size-h3:            ceil((@font-size-base * 1.25)); // ~18px
@font-size-h4:            ceil((@font-size-base * 1.07)); // ~15px
...
@border-radius-base:        0px; //4px;
@border-radius-large:       0px; //6px;
@border-radius-small:       0px; //3px;
...
@navbar-default-link-active-color:         lighten(@gray-light, 15%);
...
@state-success-text:             @gray-lighter;
@state-success-bg:               #1b926c;
...
@panel-primary-heading-bg:    @brand-blue;
...
@breadcrumb-padding-horizontal: 0px 15px;
